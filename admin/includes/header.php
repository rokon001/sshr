...
<head>
    ...
    <title><?php echo isset($pageTitle) ? $pageTitle . ' | ' : ''; ?>Admin - Start Smart HR</title>
    ...
    <div class="admin-wrapper">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar__nav">
                <a href="index.php" class="sidebar__link <?php echo $currentPage === 'index' ? 'active' : ''; ?>">
                ...
                <a href="messages.php" class="sidebar__link <?php echo $currentPage === 'messages' ? 'active' : ''; ?>">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="main-content">
            <header class="topbar">
                <div class="topbar__left">
                    <button class="topbar__toggle" id="sidebar-toggle">
                    ...
                    <h1 class="topbar__title"><?php echo isset($pageTitle) ? $pageTitle : 'Dashboard'; ?></h1>
                </div>
