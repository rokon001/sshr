        ...
        try {
            if ($id > 0) {
                ...
                $stmt->execute([
                    ...
                    $data['sort_order'], $data['active'], $id
                ]);
                ...
                $sql = "INSERT INTO packages (slug, title_hr, title_en, description_hr, description_en,
                    ...
                    show_discount, visit_url, visit_url_2, sort_order, active, created_at)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
                $stmt = db()->prepare($sql);
                $stmt->execute([
                    $data['slug'], $data['title_hr'], $data['title_en'], $data['description_hr'], $data['description_en'],
...
<form method="POST" action="">
    ...
    <div class="card">
        <div class="card__header">
            <h2 class="card__title">Značajke paketa</h2>
